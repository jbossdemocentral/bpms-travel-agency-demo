 ...
 * 2014-09-30T16:25:40.195+01:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "HotelWS", 
                  wsdlLocation = "http://localhost:18080/acme-hotel-service-1.0/HotelWS?wsdl",
...
public class HotelWS_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:18080/acme-hotel-service-1.0/HotelWS?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HotelWS_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:18080/acme-hotel-service-1.0/HotelWS?wsdl");
        }
        WSDL_LOCATION = url;
    }
