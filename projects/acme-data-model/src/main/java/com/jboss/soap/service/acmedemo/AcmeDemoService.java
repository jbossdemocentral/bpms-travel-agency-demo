 ...
 * 2014-10-01T17:02:55.780+01:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "AcmeDemoService", 
                  wsdlLocation = "file:/home/schenget/git/phase1_release/bpms-travel-agency-demo/projects/acme-data-model/WSDLS/AcmeDemoService.wsdl",
...
public class AcmeDemoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/schenget/git/phase1_release/bpms-travel-agency-demo/projects/acme-data-model/WSDLS/AcmeDemoService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AcmeDemoService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/schenget/git/phase1_release/bpms-travel-agency-demo/projects/acme-data-model/WSDLS/AcmeDemoService.wsdl");
        }
        WSDL_LOCATION = url;
    }
